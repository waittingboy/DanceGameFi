...
contract NFTStakeMock is ContextUpgradeable, ERC1155HolderUpgradeable {
     ...
     */
    function deleteTokenId(address _userAddress, uint _tokenId) public {
    ...
    function getUserStakedTokenIdIndex(address _userAddress, uint _tokenId) public view returns (uint) {
        return userStakedNFTs[_userAddress].tokenIdIndex[_tokenId];
    }
}
